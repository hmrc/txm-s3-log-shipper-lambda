...
class LogHandlerSpec(TestCase):
    ...
    @patch.dict(os.environ, {
        "OUTPUT_REDIS_HOST": "localhost", "OUTPUT_REDIS_PORT": "6579", "CONFIG_FILE": test_config_file()
    })
    ...
    def test_log_handler_happy_path(self, redis_client) -> None:
        ...
        log_str = "".join(["2020-04-28 05:58:34,602  INFO StatusTransitService$StatusTransitRunnable:520 "
